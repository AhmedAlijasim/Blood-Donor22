...
<div class="tool_box">
	...
	<div class="switch_colors">
		...
		<ul class="list-unstyled text-center">
		    <li id="color1" onclick="return change_theme('rgba(139, 0, 0, 0.55)');"></li>
		    <li id="color2" onclick="return change_theme('rgba(0, 0, 139, 0.55)');"></li>
		    <li id="color3" onclick="return change_theme('rgba(128, 0, 128, 0.55)');"></li>
		    <li id="color4" onclick="return change_theme('rgba(53, 50, 50, 0.55)');"></li>
		</ul>
	</div>
	...
	<div class="switch_languages">
		<h5 class="text-center"> Site Language</h5>
		    <ul class="list-unstyled text-center">
		        <li id="arabic"  onclick="return change_languages('rtl');">Arabic</li>
		        <li id="english" onclick="return change_languages('ltr');">English</li>
		    </ul>
	</div> 
